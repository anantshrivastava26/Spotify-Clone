  ...
  <div className="relative z-10 font-thin flex flex-row text-black">
    <div className="lft h-[93vh] w-64 border-r-[2px] flex flex-col space-y-2 border-black">
      <div className="ttle flex flex-row">
        <img src='/assets/nobglgo.png' className='h-12 w-12'/>
    ...
    <div className="main">
      ...
      <div className="top  flex flex-row h-40 mb-20 mx-10  space-x-20">
         <div className="1 flex flex-col border-[1px] border-black p-2 w-52   h-60 rounded-xl bg-black">
             <img src='/assets/bob.jpeg' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <img src='/assets/nor.jpeg' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <img src='/assets/ult.jpeg' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <img src='/assets/hny.jpeg' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
      ...
      <div className="4 flex flex-col border-[1px] border-black p-2  w-52   h-60 rounded-xl bg-black">
         <img src='/assets/pl1.png' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <div className="4 flex flex-col border-[1px] border-black p-2  w-52   h-60 rounded-xl bg-black">
         <img src='/assets/pl2.png' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <div className="4 flex flex-col border-[1px] border-black p-2  w-52   h-60 rounded-xl bg-black">
         <img src='/assets/pl3.png' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
         ...
         <div className="4 flex flex-col border-[1px] border-black p-2  w-52   h-60 rounded-xl bg-black">
         <img src='/assets/pl4.png' className='h-40 w-40 rounded-lg ml-3 mt-1'/>
